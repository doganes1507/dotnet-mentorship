...
public static class Lesson3
{
    ...
    public static int SimpleDividerCount(int n)
    {
    ...
    {
        // TODO: Реализовать функцию, принимающую целое число 'n' и преобразующую его
        // TODO: в двоичный формат. Результат возвращается в виде string
